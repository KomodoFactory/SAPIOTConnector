package de.ososoft.sapecho.utils.response;
...
public class ResponseMaker {
	...
	/**
	 * Creates an AskIntent based on the given Parameters. Use this when you need to
	 * ask the User something but don't want to show a card. Reprompt Text will be repeated until Answer is given
	 * or Program Terminates.
	 */
	public static SpeechletResponse createSimpleAskResponse(String speechText, String repromptText) {
		outputSpeech.setText(speechText);
		repromptSpeech.setText(repromptText);
		reprompt.setOutputSpeech(repromptSpeech);
	...
	public static SpeechletResponse createSimpleResponse(String speechText) {
		outputSpeech.setText(speechText);
		return SpeechletResponse.newTellResponse(outputSpeech);
	}

	/**
	 * Creates a TellIntent that Informs about the given Error.
	 */
	public static SpeechletResponse createErrorResponse(Exception e) {
		return ResponseMaker.createTellResponse("Es ist ein schwerer Fehler aufgetereten", "Schwerer Fehler aufgetreten", e.getMessage());
	}
